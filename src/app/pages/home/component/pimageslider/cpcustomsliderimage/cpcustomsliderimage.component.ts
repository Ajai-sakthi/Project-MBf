...
import { NgImageSliderService } from '../cpslider.service';
...
@Component({
  selector: 'custom-img',
  templateUrl: './cpcustomsliderimage.component.html'
})
export class SliderCustomImageComponent implements OnChanges {
  ...
  @Input() currentImageIndex: number | undefined;
  ...
  videoClickHandler(event: { srcElement: { paused: any; play: () => void; pause: () => void; }; }) {
